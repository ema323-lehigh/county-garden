...
BEGIN
    ...
    IF ((:newdep.relationship = 'child' AND :newdep.birth_date < cust_dob - (20 * 365)) OR
        (:newdep.relationship = 'parent' AND :newdep.birth_date > cust_dob + (20 * 365)) OR
        (:newdep.relationship = 'sibling' AND
            (:newdep.birth_date > cust_dob + (20 * 365)) OR
            (:newdep.birth_date < cust_dob - (20 * 365)))) THEN
